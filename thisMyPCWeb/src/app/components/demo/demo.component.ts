...
// test user is online or  offline
    ...
    constructor(private http: HttpClient, private router: Router, private connectionService: ConnectionService) {
        this.socket = io.connect('http://thismypc.com:4000');
        const self = this;
    ...
    ngOnInit() {
        ...
        this.http.post('http://thismypc.com:4000/auth/demo',
        ...
        this.http.post('http://thismypc.com:5000/myInfo/demo',
            JSON.stringify(sendData), {
                headers
            })
            .subscribe(
        ...
        this.http.post('http://thismypc.com:5000/myInfo/myPC/online/demo',
            JSON.stringify(sendData), {
                headers
            })
            .subscribe(
...
// TODO  only files can be copy this is a bug need to fixed
    ...
    logout() {
        ...
        const headers = new HttpHeaders()
            .set('Content-Type', 'application/json')
            .set('token', sessionStorage.getItem('auth') ? sessionStorage.getItem('auth') : 'thismyPc');
        this.http.post('http://thismypc.com:5000/logout/demo',
            JSON.stringify(data), {
                headers
            })
            .subscribe(
    ...
    getAccessToPC() {
        ...
        this.http.post('http://thismypc.com:5000/public/pc/access/demo',
            JSON.stringify(sendData), {
                headers
            })
            .subscribe(
    ...
    downloadFileRequest(path) {
        ...
        this.http.post('http://thismypc.com:5000/pc/downloadFileRequest/demo',
            JSON.stringify(sendData), {
                headers
            })
            .subscribe(
